...
{
    public class CreateInvoiceFromDdtProcessor : BaseInvoiceEventProcessor, IEmailProcessor
    {
        public EventType EventType => EventType.CreateInvoiceFromDDT;

        public CreateInvoiceFromDdtProcessor()
        {
        }
        ...
        public override void SendDefaultBuyerEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("CreateInvoiceFromDdtProcessor", "SendDefaultBuyerEmailForEvent", "Exception Details : ", ex);
            }
        }
        ...
        public override void SendEmail(NotificationDomain notificationDomain, NotificationEventViewModel notificationEventViewModel)
        {
            ...
            {
                LogManager.Logger.WriteException("CreateInvoiceFromDdtProcessor", "SendEmail", "Exception Details : ", ex);
            }
        }
        ...
        private string GetBuyerNotificationBody(string bodyText, string firstName)
        {
            bodyText = string.Format(bodyText,
                                       ...
                                       viewModel.DdtNumberOfInvoice,
                                       viewModel.InvoiceNumber,
                                       viewModel.DueDate.ToString(Resource.constFormatDate));
            bodyText = !viewModel.IsPartOfStatement ? notificationDomain.ReplaceBodyContent(bodyText, 1) : notificationDomain.RemoveBodyContent(bodyText, 1);
