...
{
    public class RebillInvoiceCreationProcessor : BaseInvoiceEventProcessor, IEmailProcessor
    {
        public EventType EventType => EventType.RebilledInvoiceCreated;

        public RebillInvoiceCreationProcessor()
        {
        }
