...
{
    public class BillingStatementUpdationProcessor : BaseInvoiceEventProcessor, IEmailProcessor
    {
        private new NotificationBillingStatementViewModel viewModel;
        public EventType EventType => EventType.BillingStatementUpdated;
        private string updateByUser;
        public BillingStatementUpdationProcessor()
        {
        }
        ...
        public override void Initialize(NotificationEventViewModel notificationEventViewModel)
        {
            ...
            updateByUser = ContextFactory.Current.GetDomain<HelperDomain>().GetUserNameById(notificationEventViewModel.TriggeredByUserId);
        }
        ...
        public override void SendDefaultBuyerEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("BillingStatementUpdationProcessor", "SendDefaultBuyerEmailForEvent", ex.Message, ex);
            }
        }
        ...
        public override void SendDefaultSupplierEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("BillingStatementUpdationProcessor", "SendEmail", "Exception Details : ", ex);
            }
        }
        ...
        private NotificationViewModel GetNotificationContent(EventType eventType , CompanyType companyType, string callbackUrl)
        {
            ...
            notification.Subject = string.Format(notification.Subject, viewModel.PreviousStatementName);
            return notification;
        }
        ...
        private string GetNotificationBody(string bodyText, string firstName)
        {
            bodyText = string.Format(bodyText,
                                    firstName,
                                    viewModel.PreviousStatementName,
                                    updateByUser,
