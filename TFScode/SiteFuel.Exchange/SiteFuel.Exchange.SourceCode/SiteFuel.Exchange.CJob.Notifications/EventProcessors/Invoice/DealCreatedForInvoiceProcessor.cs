...
{
    public class DealCreatedForInvoiceProcessor : BaseOrderEventProcessor, IEmailProcessor
    {
        private NotificationDealViewModel viewModel;
        public EventType EventType => EventType.DealCreatedForInvoice;

        private readonly List<string> supplierUsersEmailSent = new List<string>();

        public DealCreatedForInvoiceProcessor()
        {
        }
        ...
        public override void SendDefaultSupplierEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("DealCreatedForInvoiceProcessor", "SendDefaultSupplierEmailForEvent", ex.Message, ex);
            }
        }
        ...
        public override void SendEmail(NotificationDomain notificationDomain, NotificationEventViewModel notificationEventViewModel)
        {
            ...
            {
                LogManager.Logger.WriteException("DealCreatedForInvoiceProcessor", "SendEmail", "Exception Details : ", ex);
            }
        }
        ...
        private void SendEmailToBuyerUsers(NotificationEventViewModel notificationEventViewModel)
        {
            ...
            {
                LogManager.Logger.WriteException("DealCreatedForInvoiceProcessor", "SendEmailToBuyerUsers", ex.Message, ex);
            }
        }
