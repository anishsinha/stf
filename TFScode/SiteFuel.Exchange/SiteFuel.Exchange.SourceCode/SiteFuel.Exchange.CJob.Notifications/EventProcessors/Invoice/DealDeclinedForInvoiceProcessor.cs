...
{
    public class DealDeclinedForInvoiceProcessor : BaseOrderEventProcessor, IEmailProcessor
    {
        private NotificationDealViewModel viewModel;
        public EventType EventType => EventType.DealDeclinedForInvoice;

        private readonly List<string> supplierUsersEmailSent = new List<string>();

        public DealDeclinedForInvoiceProcessor()
        {
        }
        ...
        public override void SendDefaultSupplierEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("DealDeclinedForInvoiceProcessor", "SendDefaultSupplierEmailForEvent", ex.Message, ex);
            }
        }
        ...
        public override void SendEmail(NotificationDomain notificationDomain, NotificationEventViewModel notificationEventViewModel)
        {
            ...
            {
                LogManager.Logger.WriteException("DealDeclinedForInvoiceProcessor", "SendEmail", "Exception Details : ", ex);
            }
        }
        ...
        private void SendEmailToBuyerUsers(NotificationEventViewModel notificationEventViewModel)
        {
            ...
            {
                LogManager.Logger.WriteException("DealDeclinedForInvoiceProcessor", "SendEmailToBuyerUsers", ex.Message, ex);
            }
        }
