...
{
    public class DriverArrivedJobProcessor : BaseDispatchEventProcessor, IEmailProcessor
    {
        private NotificationDispatchViewModel viewModel;
        public EventType EventType => EventType.DriverArrivedJob;
        private readonly List<string> buyerUsersEmailSent = new List<string>();
        public DriverArrivedJobProcessor()
        {
        }
        ...
        public override void SendDefaultBuyerEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("DriverArrivedJobProcessor", "SendDefaultBuyerEmailForEvent", ex.Message, ex);
            }
        }
        ...
        public override void SendDefaultSupplierEmailForEvent(NotificationEventViewModel notificationEventViewModel, List<NotificationUserViewModel> defaultRecievers)
        {
            ...
            {
                LogManager.Logger.WriteException("DriverArrivedJobProcessor", "SendDefaultSupplierEmailForEvent", ex.Message, ex);
            }
        }
        ...
        public override void SendEmail(NotificationDomain notificationDomain, NotificationEventViewModel notificationEventViewModel)
        {
            ...
            {
                LogManager.Logger.WriteException("DriverArrivedJobProcessor", "SendEmail", "Exception Details : ", ex);
            }
        }
