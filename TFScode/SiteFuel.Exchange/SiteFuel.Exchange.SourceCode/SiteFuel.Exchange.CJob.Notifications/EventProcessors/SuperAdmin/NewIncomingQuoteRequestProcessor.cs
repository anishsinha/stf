...
{
    public class NewIncomingQuoteRequestProcessor : BaseSuperAdminEventProcessor, IEmailProcessor
    {
        private NotificationQuoteViewModel viewModel;

        public EventType EventType => EventType.NewIncomingQuoteRequest;

        public NewIncomingQuoteRequestProcessor()
        {
        }
        ...
        public override void SendEmail(NotificationDomain notificationDomain, NotificationEventViewModel notificationEventViewModel)
        {
            try
            {
                ...
                if (viewModel.QuoteId > 0)
                {
                    ...
                    notification.BodyText = string.Format(notification.BodyText, viewModel.BuyerCompany, viewModel.BuyerQuoteNumber, viewModel.EndDate);
            ...
            {
                LogManager.Logger.WriteException("NewIncomingQuoteRequestProcessor", "SendEmail", "Exception Details : ", ex);
            }
        }
    }
}
