...
{
    public class RequiredIfMultipleAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public RequiredIfMultipleAttribute(string dependentProperty, params object[] targetValue)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            var rule = new ModelClientValidationRule()
            {
                ...
                ValidationType = "requiredifmultiple",
            };
