		...
		return this.each(function() {
			...
			if ($(this).val() != '' && IsJsonString($(this).val())) {
				$.each(jQuery.parseJSON($(this).val()), function( index, val ) {
					$list.append($('<li class="multiple_emails-email dib"><span class="email_name" data-email="' + val.toLowerCase() + '">' + val + '</span></li>')
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left" />').on('keyup', function(e) { // input
				...
				if(keynum == 9 || keynum == 32 || keynum == 186 || keynum == 188) { 
