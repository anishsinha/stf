...
(function (BreadCrumbModule) {
    var bind_breadcrumb_data_key = "breadcrumbs";
    var breadcrumb_mapping_key = 'breadCrumbMapping';
    var home_page_key = 'Home';
    var home_page_url_key = 'dashboard';
    var BreadCrumb = /** @class */ (function () {
        function BreadCrumb(key, title, parents, url) {
            this.key = key;
            this.title = title;
            this.parents = parents;
            this.url = url;
        }
        BreadCrumb.prototype.AddBreadCrumb = function (breadcrumb) {
        ...
        BreadCrumb.prototype.ShowBreadCrumb = function () {
            var breadcrumbs = JSON.parse(GetSessionStorage(bind_breadcrumb_data_key));
        ...
        BreadCrumb.prototype.RemoveBreadCrumb = function (startindex) {
            var breadcrumbs = JSON.parse(GetSessionStorage(bind_breadcrumb_data_key));
            if (breadcrumbs != null) {
    ...
    BreadCrumbModule.BreadCrumb = BreadCrumb;
    ...
    function GetHomePage() {
        ...
        var breadcrumb = new BreadCrumbModule.BreadCrumb(currentPage.key, currentPage.breadcrumb_title, currentPage.parents, homePageUrl);
        return breadcrumb;
    }
