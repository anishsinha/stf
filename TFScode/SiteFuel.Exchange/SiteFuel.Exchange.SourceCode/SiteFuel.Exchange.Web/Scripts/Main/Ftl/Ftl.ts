module FtlModule {
    declare var fullTruckLoadId: number;
    declare var lessTruckLoadId: number;
    declare var defaultQuantityIndicator: number;
    declare var truckLoadDropDown: HTMLSelectElement;
    declare var quantityIndicatorDropDown: HTMLSelectElement;

    export class FtlClass {
        RemoveZeroElementFromDropdown() {
    ...
    function isFTLSelected() {
        return $(truckLoadDropDown).val() == '@((int)TruckLoadTypes.FullTruckLoad)';
    }
