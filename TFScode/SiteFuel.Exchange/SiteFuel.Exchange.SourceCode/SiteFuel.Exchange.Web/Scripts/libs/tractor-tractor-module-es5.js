...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tractor-tractor-module"], {
  /***/
  "./src/app/tractor/create-tractor/create-tractor.component.ts": function srcAppTractorCreateTractorCreateTractorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateTractorComponent", function () {
      return CreateTractorComponent;
    });
    /* harmony import */
    ...
    var src_app_carrier_companies_service_assigncarrier_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/carrier-companies/service/assigncarrier.service */
    ...
    var _service_tractor_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function CreateTractorComponent_div_13_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateTractorComponent_div_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateTractorComponent_div_21_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function CreateTractorComponent_div_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 6);
    ...
    function CreateTractorComponent_div_30_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function CreateTractorComponent_div_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 6);
    ...
    function CreateTractorComponent_option_47_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateTractorComponent_div_56_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 6);
    ...
    function CreateTractorComponent_div_57_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateTractorComponent_div_67_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CreateTractorComponent = /*#__PURE__*/function () {
      function CreateTractorComponent(fb, tractorService) {
        _classCallCheck(this, CreateTractorComponent);
      ...
      _createClass(CreateTractorComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.editedTrailerType = false;
          this.editedDriver = false;
          this.isdriverfound = false; //this.DefaultUoM = defaultUoM;

          this.IsLoading = false;
          this.Statuses = Object.keys(this.StatusEnum).filter(function (k) {
            return typeof _this.StatusEnum[k] === "number";
          }).map(function (x) {
            return {
              Id: _this.StatusEnum[x],
              Name: x == "InActive" ? "In-Active" : x == "UnderMaintenance" ? "Under-Maintenance" : x,
              Code: ""
            };
          });
          this.TrailerTypesData = Object.keys(this.TrailerTypeStatusEnum).filter(function (k) {
            return typeof _this.TrailerTypeStatusEnum[k] === "number";
          }).map(function (x) {
            return {
              Id: _this.TrailerTypeStatusEnum[x],
              Name: x,
              Code: ""
            };
          });
        ...
        key: "loadTractorDetail",
        value: function loadTractorDetail(tractor) {
          var _this2 = this;
          ...
          if (tractor.TrailerType.length > 0) {
            this.editedTrailerType = false;
            tractor.TrailerType.forEach(function (myObject) {
              var dropdowndata = new src_app_carrier_companies_service_assigncarrier_service__WEBPACK_IMPORTED_MODULE_2__["DropdownItem"]();
              ...
              _this2.trailerselectedItem.push(myObject);

              _this2.trailerselectedItemValue.push(dropdowndata);
            });
          }

          this.TractorForm.patchValue(tractor);
          this.TractorForm.get('TrailerType').patchValue(this.trailerselectedItemValue); //load the drivers
        ...
        value: function onSubmit() {
          ...
          if (this.TractorForm.get('Id').value != null && this.TractorForm.get('Id').value != "") {
            ...
            this.trailerselectedItem = [];
            items.forEach(function (myObject) {
              _this3.trailerselectedItem.push(myObject.Id);
            });
          }
          ...
          if (this.TractorForm.valid && this.trailerselectedItem.length > 0) {
            ...
            this.tractorService.postCreateTractors(this.TractorForm.value).subscribe(function (data) {
              ...
              if (data.StatusCode == 0) {
                ...
                _this3.clearTractorForm();

                _this3.onSubmitGroupData.emit();
        ...
        key: "clearTractorForm",
        value: function clearTractorForm() {
        ...
        key: "onTrailerSelect",
        value: function onTrailerSelect(item) {
        ...
        key: "OnTrailerSelectAll",
        value: function OnTrailerSelectAll(trailer) {
          var _this4 = this;

          trailer.forEach(function (item) {
            _this4.trailerselectedItem.push(item.Id);
          });
        ...
        key: "onTrailerDeSelect",
        value: function onTrailerDeSelect(item) {
          if (this.trailerselectedItem != null && this.trailerselectedItem.length > 0 && item != null) {
            var index = this.trailerselectedItem.findIndex(function (indexd) {
              return indexd == item.Id;
            });
        ...
        key: "OnTrailerDeSelectAll",
        value: function OnTrailerDeSelectAll(trailer) {
          this.trailerselectedItem = [];
          this.editedTrailerType = true;
          this.getDriverdetailsTrailerDeSelect();
        }
      }, {
        key: "getDriverdetailsTrailerDeSelect",
        value: function getDriverdetailsTrailerDeSelect() {
          var _this5 = this;

          if (this.trailerselectedItem.length > 0) {
            this.IsLoading = true;
            var trailerTypeId = this.trailerselectedItem.join(',');
            this.tractorService.getCompanyDrivers(trailerTypeId).subscribe(function (t) {
              _this5.IsLoading = false;
              _this5.DriverList = t;

              if (_this5.DriverList.length == 0) {
                _this5.isdriverfound = true;
              } else {
                _this5.isdriverfound = false;
              }

              _this5.driverselectedItem.forEach(function (xItem) {
                var indexItem = _this5.DriverList.findIndex(function (top) {
                  return top.Id === xItem.Id;
                });

                if (indexItem == -1) {
                  var indexSelectedItem = _this5.driverselectedItem.findIndex(function (top) {
                    return top.Id === xItem.Id;
                  });

                  if (indexSelectedItem != -1) {
                    _this5.driverselectedItem.splice(indexSelectedItem, 1);

                    _this5.driverselectedItem.slice(); //refresh data.


                    _this5.TractorForm.get('Drivers').patchValue(_this5.driverselectedItem);
                  }
                }
              });
            });
        ...
        value: function getDriverdetails(editMode, tractorObj) {
          var _this6 = this;
          ...
          if (this.trailerselectedItem.length > 0) {
            ...
            this.tractorService.getCompanyDrivers(trailerTypeId).subscribe(function (t) {
              ...
              if (_this6.DriverList.length == 0) {
                _this6.isdriverfound = true;
              } else {
                _this6.isdriverfound = false;
              }

              if (editMode) {
                _this6.setDriverSelectedValues(tractorObj);
              }
            });
          } else {
            this.DriverList = [];
        ...
        key: "setDriverSelectedValues",
        value: function setDriverSelectedValues(tractor) {
          var _this7 = this;

          //set the driver selected value.
          if (tractor.Drivers.length > 0) {
            this.editedDriver = false;
            tractor.Drivers.forEach(function (myObject) {
              _this7.DriverList.forEach(function (drmyObject) {
                if (drmyObject.Id == myObject.Id) {
                  _this7.driverselectedItem.push(myObject);
                }
              });
            });
        ...
        key: "onDriverSelect",
        value: function onDriverSelect(item) {
        ...
        key: "OnDriverSelectAll",
        value: function OnDriverSelectAll(driver) {
          var _this8 = this;

          driver.forEach(function (item) {
            _this8.driverselectedItem.push(item);
          });
        ...
        value: function onDriverDeSelect(item) {
          if (this.driverselectedItem != null && this.driverselectedItem.length > 0 && item != null) {
            var index = this.driverselectedItem.findIndex(function (indexd) {
              return indexd.Id == item.Id;
            });
        ...
        key: "OnDriverDeSelectAll",
        value: function OnDriverDeSelectAll(trailer) {
          this.driverselectedItem = [];
          this.editedDriver = true;
        }
      }, {
        key: "getDefaultUOM",
        value: function getDefaultUOM() {
          var _this9 = this;

          this.IsLoading = true;
          this.tractorService.getDefaultUOM().subscribe(function (response) {
            _this9.IsLoading = false;
            _this9.DefaultUoM = response;
          });
        }
      }]);
    ...
    CreateTractorComponent.ɵfac = function CreateTractorComponent_Factory(t) {
      return new (t || CreateTractorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_tractor_service__WEBPACK_IMPORTED_MODULE_5__["TractorService"]));
    };

    CreateTractorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CreateTractorComponent,
      selectors: [["app-create-tractor"]],
      outputs: {
        onSubmitGroupData: "onSubmitGroupData"
      },
      decls: 68,
      vars: 17,
      consts: [[3, "formGroup", "ngSubmit"], [1, "col-sm-12"], [1, "row"], [1, "col-sm-6"], [1, "form-group"], ["type", "hidden", "formControlName", "Id"], [1, "color-maroon"], ["type", "text", "placeholder", "Tractor ID", "formControlName", "TractorId", "tabindex", "1", "maxlength", "20", 1, "form-control"], ["class", "color-maroon", 4, "ngIf"], ["type", "text", "placeholder", "Plate", "formControlName", "Plate", "tabindex", "2", "maxlength", "100", 1, "form-control"], ["type", "text", "formControlName", "ExpirationDate", "myDatePicker", "", "tabindex", "6", 1, "form-control", "datepicker", 3, "format", "minDate", "maxDate", "onDateChange"], ["type", "text", "placeholder", "Owner", "formControlName", "Owner", "tabindex", "3", "maxlength", "100", 1, "form-control"], ["type", "text", "placeholder", "VIN", "formControlName", "VIN", "tabindex", "4", "maxlength", "100", 1, "form-control"], ["formControlName", "Status", "tabindex", "6", 1, "form-control"], [3, "ngValue", 4, "ngFor", "ngForOf"], ["id", "ddlTrailerType", "formControlName", "TrailerType", "tabindex", "5", 3, "placeholder", "settings", "data", "onSelect", "onDeSelect", "onSelectAll", "onDeSelectAll"], ["class", "text-warning", 4, "ngIf"], ["id", "ddlDrivers", "formControlName", "Drivers", "tabindex", "7", 3, "placeholder", "settings", "data", "onSelect", "onDeSelect", "onSelectAll", "onDeSelectAll"], [1, "col-sm-12", "text-right", "form-buttons"], ["type", "button", "value", "Cancel", "onclick", "closeSlidePanel()", 1, "btn", 3, "click"], ["id", "SubmitTractor", "type", "submit", "aria-invalid", "false", 1, "btn", "btn-lg", "btn-primary", "valid"], ["class", "loader", 4, "ngIf"], [4, "ngIf"], [3, "ngValue"], [1, "text-warning"], [1, "loader"], [1, "loading-content", "text-center"], [1, "spinner"], [1, "font-bold"]],
      template: function CreateTractorComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function CreateTractorComponent_Template_form_ngSubmit_0_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onDateChange", function CreateTractorComponent_Template_input_onDateChange_29_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelect", function CreateTractorComponent_Template_ng_multiselect_dropdown_onSelect_55_listener($event) {
            return ctx.onTrailerSelect($event);
          })("onDeSelect", function CreateTractorComponent_Template_ng_multiselect_dropdown_onDeSelect_55_listener($event) {
            return ctx.onTrailerDeSelect($event);
          })("onSelectAll", function CreateTractorComponent_Template_ng_multiselect_dropdown_onSelectAll_55_listener($event) {
            return ctx.OnTrailerSelectAll($event);
          })("onDeSelectAll", function CreateTractorComponent_Template_ng_multiselect_dropdown_onDeSelectAll_55_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelect", function CreateTractorComponent_Template_ng_multiselect_dropdown_onSelect_62_listener($event) {
            return ctx.onDriverSelect($event);
          })("onDeSelect", function CreateTractorComponent_Template_ng_multiselect_dropdown_onDeSelect_62_listener($event) {
            return ctx.onDriverDeSelect($event);
          })("onSelectAll", function CreateTractorComponent_Template_ng_multiselect_dropdown_onSelectAll_62_listener($event) {
            return ctx.OnDriverSelectAll($event);
          })("onDeSelectAll", function CreateTractorComponent_Template_ng_multiselect_dropdown_onDeSelectAll_62_listener($event) {
            return ctx.OnDriverDeSelectAll($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateTractorComponent_Template_input_click_64_listener() {
            return ctx.clearTractorForm();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CreateTractorComponent, [{
        ...
        return [{
          ...
          type: _service_tractor_service__WEBPACK_IMPORTED_MODULE_5__["TractorService"]
        }];
      }, {
        onSubmitGroupData: [{
  ...
  /***/
  "./src/app/tractor/service/tractor.service.ts": function srcAppTractorServiceTractorServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TractorService", function () {
    ...
    var TractorService = /*#__PURE__*/function (_src_app_errors_Handl) {
      _inherits(TractorService, _src_app_errors_Handl);

      var _super = _createSuper(TractorService);

      function TractorService(httpClient) {
        var _this10;

        _classCallCheck(this, TractorService);

        _this10 = _super.call(this);
        _this10.httpClient = httpClient;
        _this10.postTractorData = '/Carrier/Tractor/Create';
        _this10.urlDeleteTractorData = '/Carrier/Tractor/DeleteTractor';
        _this10.urlGetTractors = '/Carrier/Tractor/GetAllTractorDetails';
        _this10.urlGetCompanyDrivers = 'Carrier/Tractor/GetCompanyDrivers?trailerId=';
        _this10.urlGetDefaultUOM = 'Carrier/Tractor/GetDefaultUOM';
        return _this10;
      }

      _createClass(TractorService, [{
        key: "getAllTractors",
        value: function getAllTractors() {
          return this.httpClient.get(this.urlGetTractors).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError('getAllTractors', null)));
        }
      }, {
        key: "getCompanyDrivers",
        value: function getCompanyDrivers(trailerId) {
          return this.httpClient.get(this.urlGetCompanyDrivers + trailerId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError('getCompanyDrivers', null)));
        }
      }, {
        key: "postCreateTractors",
        value: function postCreateTractors(inputData) {
          return this.httpClient.post(this.postTractorData, inputData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError('postCreateTractors', null)));
        }
      }, {
        key: "postDeleteTractor",
        value: function postDeleteTractor(inputData) {
          return this.httpClient.post(this.urlDeleteTractorData, inputData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError('postDeleteTractor', null)));
        }
      }, {
        key: "getDefaultUOM",
        value: function getDefaultUOM() {
          return this.httpClient.get(this.urlGetDefaultUOM).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError('getDefaultUOM', null)));
        }
      }]);
    ...
    TractorService.ɵfac = function TractorService_Factory(t) {
      return new (t || TractorService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]));
    };

    TractorService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
      token: TractorService,
      factory: TractorService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](TractorService, [{
  ...
  /***/
  "./src/app/tractor/tractor.module.ts": function srcAppTractorTractorModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TractorModule", function () {
      return TractorModule;
    });
    /* harmony import */
    ...
    var _view_tractor_view_tractor_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./view-tractor/view-tractor.component */
    "./src/app/tractor/view-tractor/view-tractor.component.ts");
    /* harmony import */


    var _create_tractor_create_tractor_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./create-tractor/create-tractor.component */
    ...
    var TractorModule = function TractorModule() {
      _classCallCheck(this, TractorModule);
    };

    TractorModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: TractorModule
    });
    TractorModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function TractorModule_Factory(t) {
        return new (t || TractorModule)();
      },
      imports: [[_modules_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _modules_directive_module__WEBPACK_IMPORTED_MODULE_3__["DirectiveModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_4__["DataTablesModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routeTractor)]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TractorModule, {
        declarations: [_view_tractor_view_tractor_component__WEBPACK_IMPORTED_MODULE_5__["ViewTractorComponent"], _create_tractor_create_tractor_component__WEBPACK_IMPORTED_MODULE_6__["CreateTractorComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TractorModule, [{
  ...
  /***/
  "./src/app/tractor/view-tractor/view-tractor.component.ts": function srcAppTractorViewTractorViewTractorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewTractorComponent", function () {
      return ViewTractorComponent;
    });
    /* harmony import */
    ...
    var _create_tractor_create_tractor_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../create-tractor/create-tractor.component */
    "./src/app/tractor/create-tractor/create-tractor.component.ts");
    /* harmony import */
    ...
    var src_app_shared_components_create_trailer_create_trailer_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _service_tractor_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../service/tractor.service */
    "./src/app/tractor/service/tractor.service.ts");
    /* harmony import */
    ...
    function ViewTractorComponent_tr_46_a_3_Template(rf, ctx) {
      if (rf & 1) {
        var _r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 77);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_tr_46_a_3_Template_a_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);

          var truck_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r22.OpenTrailerDetails(truck_r4.Id);
        });
    ...
    function ViewTractorComponent_tr_46_span_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewTractorComponent_tr_46_span_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_27_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_span_28_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_46_div_30_span_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
      ...
      if (rf & 2) {
        var comp_r32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function ViewTractorComponent_tr_46_div_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewTractorComponent_tr_46_div_31_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewTractorComponent_tr_46_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_tr_46_Template_button_click_37_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r36);

          var truck_r4 = ctx.$implicit;

          var ctx_r35 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r35.createTrailer("Edit Trailer");
          return ctx_r35.editTruck(truck_r4);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("confirm", function ViewTractorComponent_tr_46_Template_button_confirm_39_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r36);
          ...
          return ctx_r37.deleteTruck(truck_r4);
        });
    ...
    function ViewTractorComponent_tr_99_span_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
      ...
      if (rf & 2) {
        var tractor_r38 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function ViewTractorComponent_tr_99_span_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_span_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_span_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_span_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_span_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_span_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_span_14_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_99_div_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      if (rf & 2) {
        var trailerType_r55 = ctx.$implicit;
    ...
    function ViewTractorComponent_tr_99_div_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewTractorComponent_tr_99_div_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      if (rf & 2) {
        var driverName_r56 = ctx.$implicit;
    ...
    function ViewTractorComponent_tr_99_div_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewTractorComponent_tr_99_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_tr_99_Template_button_click_24_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r58);

          var tractor_r38 = ctx.$implicit;

          var ctx_r57 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r57.createTractor("Edit Tractor");
          return ctx_r57.editTractor(tractor_r38);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("confirm", function ViewTractorComponent_tr_99_Template_button_confirm_26_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r58);
          ...
          return ctx_r59.deleteTractor(tractor_r38);
        });
    ...
    function ViewTractorComponent_div_109_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewTractorComponent_tr_133_span_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_133_span_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ViewTractorComponent_tr_133_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    ...
    var ViewTractorComponent = /*#__PURE__*/function () {
      function ViewTractorComponent(tractorService, carrierService) {
        _classCallCheck(this, ViewTractorComponent);
      ...
      _createClass(ViewTractorComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        key: "intializeTrailer",
        value: function intializeTrailer() {
          this.IsLoading = true;
          this.ModalTextTrailer = 'Create Trailer';
          var exportColumnsTrailer = {
            columns: ':visible'
          };
          this.dtOptionsTrailer = {
            ...
            buttons: [{
              ...
              extend: 'copy',
              exportOptions: exportColumnsTrailer
            }, {
              extend: 'csv',
        ...
        key: "intializeTractors",
        value: function intializeTractors() {
          this.IsLoading = true;
        ...
        key: "editTractor",
        value: function editTractor(tractor) {
        ...
        key: "deleteTractor",
        value: function deleteTractor(tractor) {
          var _this11 = this;

          this.tractorService.postDeleteTractor(tractor).subscribe(function (data) {
            if (data.StatusCode == 0) {
              src_app_declarations_module__WEBPACK_IMPORTED_MODULE_3__["Declarations"].msgsuccess(data.StatusMessage, undefined, undefined);

              _this11.loadTractorDetails();
            }
          });
        }
      }, {
        ...
        value: function deleteTruck(truck) {
          ...
          this.carrierService.postDeleteTruck(truck).subscribe(function (data) {
            if (data.StatusCode == 0) {
              ...
              _this12.loadTruckDetails();
            }
          });
        }
      }, {
        key: "createTractor",
        value: function createTractor(header) {
          this.ModalText = header; //this.IsCreateTruck = true;
        }
      }, {
        key: "createTrailer",
        value: function createTrailer(header) {
          this.ModalTextTrailer = header; //this.IsCreateTruck = true;
        }
      }, {
        key: "getAllTractor",
        value: function getAllTractor() {
          var _this13 = this;

          this.tractorService.getAllTractors().subscribe(function (data) {
            _this13.IsLoading = false;
            _this13.Tractors = data;
        ...
        key: "clearPanelDataTrailer",
        value: function clearPanelDataTrailer() {
          if (this.TrailerComponent != undefined) {
            this.TrailerComponent.clearTrailerForm();
          }
        }
      }, {
        key: "loadTractorDetails",
        value: function loadTractorDetails() {
          this.getAllTractor();
        ...
        key: "OpenTrailerDetails",
        value: function OpenTrailerDetails(Id) {
          this.CompartmentDetails = [];
          var trucksDetail = this.Trucks.find(function (top) {
            return top.Id == Id;
          });
    ...
    ViewTractorComponent.ɵfac = function ViewTractorComponent_Factory(t) {
      return new (t || ViewTractorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_tractor_service__WEBPACK_IMPORTED_MODULE_6__["TractorService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_carrier_service_carrier_service__WEBPACK_IMPORTED_MODULE_7__["CarrierService"]));
    };

    ViewTractorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ViewTractorComponent,
      selectors: [["app-view-tractor"]],
      viewQuery: function ViewTractorComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function ViewTractorComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_Template_a_click_6_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_Template_a_click_50_listener() {
            return ctx.clearPanelDataTrailer();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSubmitGroupData", function ViewTractorComponent_Template_app_create_trailer_onSubmitGroupData_55_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_Template_a_click_67_listener() {
            return ctx.createTractor("Create Tractor");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewTractorComponent_Template_a_click_103_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSubmitGroupData", function ViewTractorComponent_Template_app_create_tractor_onSubmitGroupData_108_listener() {
            return ctx.loadTractorDetails();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ViewTractorComponent, [{
        ...
        return [{
          type: _service_tractor_service__WEBPACK_IMPORTED_MODULE_6__["TractorService"]
        }, {
...
//# sourceMappingURL=tractor-tractor-module-es5.js.map