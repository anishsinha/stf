...
function NgxJsonViewerComponent_section_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NgxJsonViewerComponent_section_1_Template_section_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const segment_r1 = ctx.$implicit; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.toggle(segment_r1); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgxJsonViewerComponent, [{
...
NgxJsonViewerModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: NgxJsonViewerModule });
NgxJsonViewerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function NgxJsonViewerModule_Factory(t) { return new (t || NgxJsonViewerModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NgxJsonViewerModule, { declarations: function () { return [NgxJsonViewerComponent]; }, imports: function () { return [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]]; }, exports: function () { return [NgxJsonViewerComponent]; } }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgxJsonViewerModule, [{
...
/*!********************************************************************!*\
  !*** ./src/app/tpd-api-dashboard/dashboard/dashboard.component.ts ***!
  \********************************************************************/
/*! exports provided: DashboardComponent, ApiDashBoardModel, ApiDetailModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DashboardComponent", function() { return DashboardComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiDashBoardModel", function() { return ApiDashBoardModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiDetailModel", function() { return ApiDetailModel; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _service_api_dashboard_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../service/api-dashboard.service */ "./src/app/tpd-api-dashboard/service/api-dashboard.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _directives_myDateTimePicker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../directives/myDateTimePicker */ "./src/app/directives/myDateTimePicker.ts");
/* harmony import */ var ngx_json_viewer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-json-viewer */ "./node_modules/ngx-json-viewer/__ivy_ngcc__/ngx-json-viewer.js");
...
function DashboardComponent_option_11_Template(rf, ctx) { if (rf & 1) {
...
function DashboardComponent_tr_62_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_tr_62_Template_button_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const log_r7 = ctx.$implicit; const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.showReqRes(log_r7, ctx_r8.ReqResType.Request); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_tr_62_Template_button_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const log_r7 = ctx.$implicit; const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.showReqRes(log_r7, ctx_r10.ReqResType.Response); });
...
function DashboardComponent_ngx_json_viewer_71_Template(rf, ctx) { if (rf & 1) {
...
class DashboardComponent {
    constructor(dashbpardSer) {
        ...
        this.viewType = src_app_app_enum__WEBPACK_IMPORTED_MODULE_4__["ApiResultType"].Total;
        //min max date
    ...
    showReqRes(log, reqResType) {
        this.IsLoading = true;
        this.selectedReqRes = null;
        this.dashbpardSer.getApiReqRes(log.Id, reqResType).subscribe(data => {
            this.IsLoading = false;
            reqResType == src_app_app_enum__WEBPACK_IMPORTED_MODULE_4__["ReqResType"].Request ? this.selectedReqRes = JSON.parse(data.Request) : this.selectedReqRes = JSON.parse(data.Response);
            reqResType == src_app_app_enum__WEBPACK_IMPORTED_MODULE_4__["ReqResType"].Request ? this.modelHeader = 'Request (' + log.Url + " )" : this.modelHeader = 'Response (' + log.Url + " )";
        });
        // reqResType == 2 ? this.selectedReqRes = JSON.parse(log.Request) : this.selectedReqRes = JSON.parse(log.Response);
    }
    setFromDate(event) {
        this.fromDate = (event);
        let d = moment__WEBPACK_IMPORTED_MODULE_2__(new Date(new Date().setMonth(new Date().getMonth() + 1))).toDate();
        !this.toDate ? this.toDate = (moment__WEBPACK_IMPORTED_MODULE_2__(d).format('MM/DD/YYYY')) : '';
        if (this.fromDate != '' && this.toDate != '') {
            let _fromDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.fromDate).toDate();
            let _toDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.toDate).toDate();
...
DashboardComponent.ɵfac = function DashboardComponent_Factory(t) { return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_api_dashboard_service__WEBPACK_IMPORTED_MODULE_5__["ApiDashboardService"])); };
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function DashboardComponent_Template_select_change_10_listener($event) { return ctx.apiChanged($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DashboardComponent_Template_input_ngModelChange_13_listener($event) { return ctx.fromDate = $event; })("onDateChange", function DashboardComponent_Template_input_onDateChange_13_listener($event) { return ctx.setFromDate($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "div", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "input", 10, 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DashboardComponent_Template_input_ngModelChange_16_listener($event) { return ctx.toDate = $event; })("onDateChange", function DashboardComponent_Template_input_onDateChange_16_listener($event) { return ctx.setToDate($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "div", 13);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](19, "input", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_Template_input_click_19_listener() { return ctx.ReloadDataTable(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_Template_a_click_23_listener() { return ctx.getView(ctx.ApiResultType.Total); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_Template_a_click_28_listener() { return ctx.getView(ctx.ApiResultType.Success); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_Template_a_click_33_listener() { return ctx.getView(ctx.ApiResultType.Exception); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardComponent, [{
    ...
    }], function () { return [{ type: _service_api_dashboard_service__WEBPACK_IMPORTED_MODULE_5__["ApiDashboardService"] }]; }, { datatableElement: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: [angular_datatables__WEBPACK_IMPORTED_MODULE_3__["DataTableDirective"]]
        }] }); })();
class ApiDashBoardModel {
}
...
/*!********************************************************************!*\
  !*** ./src/app/tpd-api-dashboard/service/api-dashboard.service.ts ***!
  \********************************************************************/
/*! exports provided: ApiDashboardService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiDashboardService", function() { return ApiDashboardService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class ApiDashboardService extends src_app_errors_HandleError__WEBPACK_IMPORTED_MODULE_1__["HandleError"] {
    constructor(httpClient) {
        super();
        this.httpClient = httpClient;
        this.getAllLogUrl = '/Home/GetApiLogs?companyId=';
        this.getReqResUrl = '/Home/GetApiLogRequestResponse?id=';
    }
    getApiLogs(currentCompanyId, fromDate, toDate, selectedApi, viewType) {
        return this.httpClient.get(this.getAllLogUrl + currentCompanyId + "&fromdate=" + fromDate + "&toDate=" + toDate + "&viewType=" + viewType + "&apiName=" + selectedApi)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('getApiLogs', null)));
    }
    getApiReqRes(id, reqResType) {
        return this.httpClient.get(this.getReqResUrl + id + "&ReqResType=" + reqResType)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('GetApiLogRequestResponse', null)));
    }
}
ApiDashboardService.ɵfac = function ApiDashboardService_Factory(t) { return new (t || ApiDashboardService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
ApiDashboardService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ApiDashboardService, factory: ApiDashboardService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ApiDashboardService, [{
...
/***/ "./src/app/tpd-api-dashboard/tpd-api-dashboard.module.ts":
/*!***************************************************************!*\
  !*** ./src/app/tpd-api-dashboard/tpd-api-dashboard.module.ts ***!
  \***************************************************************/
/*! exports provided: TpdApiDashboardModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TpdApiDashboardModule", function() { return TpdApiDashboardModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/tpd-api-dashboard/dashboard/dashboard.component.ts");
...
/* harmony import */ var _modules_directive_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/directive.module */ "./src/app/modules/directive.module.ts");
...
class TpdApiDashboardModule {
}
TpdApiDashboardModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: TpdApiDashboardModule });
TpdApiDashboardModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function TpdApiDashboardModule_Factory(t) { return new (t || TpdApiDashboardModule)(); }, imports: [[
            _modules_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"],
            _modules_directive_module__WEBPACK_IMPORTED_MODULE_5__["DirectiveModule"],
            ngx_json_viewer__WEBPACK_IMPORTED_MODULE_4__["NgxJsonViewerModule"],
            angular_datatables__WEBPACK_IMPORTED_MODULE_6__["DataTablesModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routeTpd)
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TpdApiDashboardModule, { declarations: [_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_1__["DashboardComponent"]], imports: [_modules_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"],
        _modules_directive_module__WEBPACK_IMPORTED_MODULE_5__["DirectiveModule"],
        ngx_json_viewer__WEBPACK_IMPORTED_MODULE_4__["NgxJsonViewerModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TpdApiDashboardModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
...
//# sourceMappingURL=tpd-api-dashboard-tpd-api-dashboard-module-es2015.js.map