...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["order-lazy-loading-order-module"], {
  /***/
  "./src/app/order/create-blend-group/create-blend-group.component.ts": function srcAppOrderCreateBlendGroupCreateBlendGroupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateBlendGroupComponent", function () {
      return CreateBlendGroupComponent;
    });
    /* harmony import */
    ...
    var ng_drag_drop__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ng-drag-drop */
    "./node_modules/ng-drag-drop/__ivy_ngcc__/index.js");
    /* harmony import */


    var ng_drag_drop__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */
    ...
    function CreateBlendGroupComponent_div_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateBlendGroupComponent_div_20_div_17_span_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateBlendGroupComponent_div_20_div_17_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function CreateBlendGroupComponent_div_20_div_17_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateBlendGroupComponent_div_20_div_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateBlendGroupComponent_div_20_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateBlendGroupComponent_div_20_Template_a_click_19_listener() {
          ...
          return ctx_r13.removeBlend(i_r7);
        });
    ...
    function CreateBlendGroupComponent_div_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateBlendGroupComponent_input_33_Template(rf, ctx) {
      if (rf & 1) {
        var _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 48);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateBlendGroupComponent_input_33_Template_input_click_0_listener() {
    ...
    function CreateBlendGroupComponent_input_34_Template(rf, ctx) {
      if (rf & 1) {
        var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 49);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateBlendGroupComponent_input_34_Template_input_click_0_listener() {
    ...
    function CreateBlendGroupComponent_div_35_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CreateBlendGroupComponent = /*#__PURE__*/function () {
      function CreateBlendGroupComponent(fb, orderService, viewGroupService) {
        _classCallCheck(this, CreateBlendGroupComponent);
      ...
      _createClass(CreateBlendGroupComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          if (IsSupplierCompany) {
            this.orderService.getCustomerList().subscribe(function (data) {
              return _this.CustomerList = data;
            });
          } else {
            this.orderService.getSupplierList().subscribe(function (data) {
              return _this.CustomerList = data;
            });
          }

          this.viewGroupService.currentGroup.subscribe(function (id) {
            _this.groupId = id;

            if (id > 0) {
              _this.clearBlendGroupForm();
        ...
        key: "selectedFuelTypeList",
        get: function get() {
          return this.SelectedFuelTypes.map(function (x) {
            return x.Id;
          });
        }
      }, {
        ...
        key: "onItemDrop",
        value: function onItemDrop(order) {
        ...
        key: "setSelectedOrders",
        value: function setSelectedOrders(order) {
          this.OrderBlendedGroups.push(this.buildProduct(order));
          this.orderList = this.orderList.filter(function (x) {
            return x.FuelType !== order.FuelType;
          });
        }
      }, {
        key: "onFuelSelect",
        value: function onFuelSelect(item) {
          this.loadOrders(this.Customer.Id, this.Job.Id, this.selectedFuelTypeList);
        }
      }, {
        key: "onFuelDeSelect",
        value: function onFuelDeSelect(item) {
          this.RemoveOrder(item.Name);
          this.RemoveGroups(item.Name);
        }
      }, {
        key: "removeBlend",
        value: function removeBlend(i) {
          this.OrderBlendedGroups.removeAt(i);
          var selectedFuelTypes = this.OrderBlendedGroups.controls.map(function (x) {
            return x.get('FuelType').value;
          });
          var fuelTypeIds = this.FuelTypeList.map(function (t) {
            if (selectedFuelTypes.indexOf(t.Name) > -1) return t.Id;
          });
          var loadedFuelType = this.selectedFuelTypeList.filter(function (x) {
            return fuelTypeIds.indexOf(x) == -1;
          });
          this.SetDefaultBlendPercentage();
        ...
        key: "RemoveOrder",
        value: function RemoveOrder(fuelTypeName) {
          this.orderList = this.orderList.filter(function (obj) {
            return obj.FuelType !== fuelTypeName;
          });
        }
      }, {
        key: "loadOrders",
        value: function loadOrders(_customerId, _jobId, _fuelTypeIds) {
          var _this2 = this;

          this.orderService.getFilteredOrdersList(_customerId, _jobId, _fuelTypeIds, this.groupId).subscribe(function (data) {
            var existingOrderList = _this2.OrderBlendedGroups.controls.map(function (x) {
              return x.get('OrderId').value;
            });

            _this2.orderList = data.filter(function (ele) {
              return existingOrderList.indexOf(ele.OrderId) == -1;
            });
          });
        }
      }, {
        key: "loadFuelType",
        value: function loadFuelType(_customerId, _jobId) {
          var _this3 = this;

          this.orderService.getFuelTypesList(_customerId, _jobId).subscribe(function (data) {
            _this3.FuelTypeList = data;
          });
        }
      }, {
        key: "RemoveGroups",
        value: function RemoveGroups(_FuelType) {
          //this.usedOrderGroupDetails = this.usedOrderGroupDetails.filter(x => x.FuelType !== _FuelType);
          this.OrderBlendedGroups.setValue(this.OrderBlendedGroups.controls.filter(function (group) {
            return group.get('FuelType').value !== _FuelType;
          }));
          this.SetDefaultBlendPercentage();
        }
      }, {
        key: "SetDefaultBlendPercentage",
        value: function SetDefaultBlendPercentage() {
          var totalFuelTypes = this.OrderBlendedGroups.length;
          var equalPercent = (100 / totalFuelTypes).toFixed(2);
          this.OrderBlendedGroups.controls.forEach(function (x) {
            x.get('BlendPercentage').setValue(equalPercent);
          });
        }
      }, {
        key: "OnCustomerSelect",
        value: function OnCustomerSelect(customer) {
          var _this4 = this;

          this.SelectedJob = '';
          this.SelectedFuelTypes = [];
          this.OrderBlendedGroups.clear();
          this.orderService.getCommonJobList(customer.Id).subscribe(function (data) {
            return _this4.JobList = data;
          });
        }
      }, {
        key: "OnCustomerDeSelect",
        value: function OnCustomerDeSelect(customer) {
        ...
        key: "OnJobSelect",
        value: function OnJobSelect(job) {
          this.orderList = [];
          this.OrderBlendedGroups.clear();
          this.SelectedFuelTypes = [];
        ...
        key: "OnJobDeSelect",
        value: function OnJobDeSelect(job) {
          this.FuelTypeList = [];
          this.SelectedFuelTypes = [];
          this.orderList = [];
          this.OrderBlendedGroups.clear();
        ...
        value: function OnSubmit() {
          ...
          var blendValue = this.OrderBlendedGroups.controls.map(function (x) {
            return parseFloat(x.get('BlendPercentage').value);
          });
          var sum = 0;
          blendValue.forEach(function (x) {
            return sum += x;
          });
          ...
          if (this.BlendGroupForm.valid) {
            ...
            if (this.isEdit) {
              this.orderService.postEditGroup(this.finalSubmitData).subscribe(function (data) {
                _this5.IsLoading = false;

                if (data.StatusCode == 0) {
                  _declarations_module__WEBPACK_IMPORTED_MODULE_2__["Declarations"].msgsuccess(data.StatusMessage, undefined, undefined);

                  _this5.clearBlendGroupForm();

                  closeSlidePanel();

                  _this5.onSubmitGroupData.emit();
                } else {
              ...
              this.orderService.postCreateGroup(this.finalSubmitData).subscribe(function (data) {
                _this5.IsLoading = false;
        ...
        value: function GetGroupDetails() {
          ...
          this.orderService.getBlendGroupDetails(this.groupId).subscribe(function (group) {
            _this6.JobList = group.Jobs;
            _this6.FuelTypeList = group.FuelTypes;
            _this6.orderList = group.FilteredOrders;

            _this6.CustomerPoNumber.setValue(group.GroupDetails.GroupPoNumber);

            _this6.SelectedCustomer = IsSupplierCompany ? _this6.getCustomerFromSupplier(group.GroupDetails.BuyerCompanyId) : _this6.getCustomerFromSupplier(group.GroupDetails.SupplierCompanyId);
            _this6.SelectedJob = _this6.JobList.filter(function (ele) {
              return ele.Id == group.GroupDetails.JobId;
            });

            var _fuelTypes = group.GroupDetails.OrderList.map(function (x) {
              return x.Order.FuelType;
            });

            _this6.SelectedFuelTypes = _this6.FuelTypeList.filter(function (ele) {
              return _fuelTypes.indexOf(ele.Name) > -1;
            });

            for (var i = 0; i < group.GroupDetails.OrderList.length; i++) {
              var orderDetail = group.GroupDetails.OrderList[i];

              var orderToMove = _this6.orderList.filter(function (t) {
                return t.OrderId == orderDetail.OrderId;
              });

              _this6.setSelectedOrders(orderToMove[0]);
            }
          });
        }
      }, {
        key: "getCustomerFromSupplier",
        value: function getCustomerFromSupplier(id) {
          return this.CustomerList.filter(function (e) {
            return e.Id == id;
          });
        }
      }, {
        key: "clearBlendGroupForm",
        value: function clearBlendGroupForm() {
    ...
    CreateBlendGroupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CreateBlendGroupComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
            return ctx.SelectedCustomer = $event;
          })("onSelect", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
            return ctx.OnCustomerSelect($event);
          })("onDeSelect", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
            return ctx.OnCustomerDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_8_listener($event) {
            return ctx.SelectedJob = $event;
          })("onSelect", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_onSelect_8_listener($event) {
            return ctx.OnJobSelect($event);
          })("onDeSelect", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_8_listener($event) {
            return ctx.OnJobDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_12_listener($event) {
            return ctx.SelectedFuelTypes = $event;
          })("onSelect", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_onSelect_12_listener($event) {
            return ctx.onFuelSelect($event);
          })("onDeSelect", function CreateBlendGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_12_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onDrop", function CreateBlendGroupComponent_Template_div_onDrop_17_listener($event) {
            return ctx.onItemDrop($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateBlendGroupComponent_Template_input_click_32_listener() {
            return ctx.clearBlendGroupForm();
          });
  ...
  /***/
  "./src/app/order/create-same-dest-group/create-same-dest-group.component.ts": function srcAppOrderCreateSameDestGroupCreateSameDestGroupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateSameDestGroupComponent", function () {
      return CreateSameDestGroupComponent;
    });
    /* harmony import */
    ...
    function CreateSameDestGroupComponent_div_18_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateSameDestGroupComponent_div_18_Template_div_click_1_listener() {
          ...
          return ctx_r6.OrderClicked(order_r5);
        });
    ...
    function CreateSameDestGroupComponent_span_23_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function CreateSameDestGroupComponent_span_23_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CreateSameDestGroupComponent_input_27_Template(rf, ctx) {
      if (rf & 1) {
        var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 22);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateSameDestGroupComponent_input_27_Template_input_click_0_listener() {
    ...
    function CreateSameDestGroupComponent_input_28_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 23);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateSameDestGroupComponent_input_28_Template_input_click_0_listener() {
    ...
    function CreateSameDestGroupComponent_div_29_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CreateSameDestGroupComponent = /*#__PURE__*/function () {
      function CreateSameDestGroupComponent(fb, orderService, viewGroupService) {
        _classCallCheck(this, CreateSameDestGroupComponent);
      ...
      _createClass(CreateSameDestGroupComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this7 = this;
          ...
          if (IsSupplierCompany) {
            this.orderService.getCustomerList().subscribe(function (data) {
              return _this7.CustomerList = data;
            });
          } else {
            this.orderService.getSupplierList().subscribe(function (data) {
              return _this7.CustomerList = data;
        ...
        key: "OrderClicked",
        value: function OrderClicked(orderData) {
          var obj = this.orderList.find(function (o) {
            return o.OrderId == orderData.OrderId;
          });
          obj.IsOrderSelected = !obj.IsOrderSelected;
          this.orderListSelected = this.orderList.filter(function (t) {
            return t.IsOrderSelected == true;
          });
        }
      }, {
        key: "CustomerPoNumber",
        ...
        key: "onAllFuelDeSelect",
        value: function onAllFuelDeSelect(items) {
          this.orderList = [];
        }
      }, {
        key: "onFuelDeSelect",
        ...
        value: function loadOrders(_customerId, _jobId, _fuelTypeIds) {
          ...
          this.orderService.getFilteredOrdersList(_customerId, _jobId, _fuelTypeIds, this.groupId).subscribe(function (data) {
            ...
            for (var i = 0; i < _this8.orderListSelected.length; i++) {
              _this8.orderList.filter(function (x) {
                return x.OrderId == _this8.orderListSelected[i].OrderId;
              }).forEach(function (t) {
                return t.IsOrderSelected = _this8.orderListSelected[i].IsOrderSelected;
              });
            }
          });
        }
        ...
        value: function loadFuelType(_customerId, _jobId) {
          ...
          this.orderService.getFuelTypesList(_customerId, _jobId).subscribe(function (data) {
            _this9.FuelTypeList = data;
          });
        }
      }, {
        key: "RemoveOrders",
        value: function RemoveOrders(_FuelType) {
          this.orderList = this.orderList.filter(function (t) {
            return t.FuelType != _FuelType;
          });
          this.orderListSelected = this.orderListSelected.filter(function (t) {
            return t.FuelType != _FuelType;
          });
        }
      }, {
        ...
        value: function OnSubmit() {
          ...
          if (this.orderListSelected.length < 2) {
            ...
            this.SameDestGroupForm.setErrors({
              'invalid': true
            });
          }
            ...
            if (this.isEdit) {
              this.orderService.postEditGroup(this.finalSubmitData).subscribe(function (data) {
                ...
                if (data.StatusCode == 0) {
                  ...
                  _this11.clearDestGroupForm();

                  closeSlidePanel();

                  _this11.onSubmitGroupData.emit();
                } else {
                  _declarations_module__WEBPACK_IMPORTED_MODULE_2__["Declarations"].msgerror(data == null ? 'Failed' : data.StatusMessage, undefined, undefined);
                }
              });
        ...
        value: function GetGroupDetails() {
          ...
          this.orderService.getBlendGroupDetails(this.groupId).subscribe(function (group) {
            _this12.JobList = group.Jobs;
            _this12.FuelTypeList = group.FuelTypes;
            _this12.orderList = group.FilteredOrders;

            _this12.CustomerPoNumber.setValue(group.GroupDetails.GroupPoNumber);

            _this12.SelectedCustomer = IsSupplierCompany ? _this12.getCustomerFromSupplier(group.GroupDetails.BuyerCompanyId) : _this12.getCustomerFromSupplier(group.GroupDetails.SupplierCompanyId);
            _this12.SelectedJob = _this12.JobList.filter(function (ele) {
              return ele.Id == group.GroupDetails.JobId;
            });
            ...
            _this12.SelectedFuelTypes = _this12.FuelTypeList.filter(function (ele) {
              return _fuelTypes.indexOf(ele.Name) > -1;
            });

            _this12.orderList.filter(function (ele) {
              return _fuelTypes.indexOf(ele.FuelType) > -1;
            }).forEach(function (t) {
              return t.IsOrderSelected = true;
            });

            _this12.orderListSelected = _this12.orderList.filter(function (x) {
              return x.IsOrderSelected == true;
            }); //for (var i = 0; i < group.GroupDetails.OrderList.length; i++) {
        ...
        key: "clearDestGroupForm",
        value: function clearDestGroupForm() {
          if (this.SelectedCustomer != null) {
            this.OnCustomerDeSelect(this.SelectedCustomer);
          }
    ...
    CreateSameDestGroupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CreateSameDestGroupComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
            return ctx.SelectedCustomer = $event;
          })("onSelect", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
            return ctx.OnCustomerSelect($event);
          })("onDeSelect", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
            return ctx.OnCustomerDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_8_listener($event) {
            return ctx.SelectedJob = $event;
          })("onSelect", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onSelect_8_listener($event) {
            return ctx.OnJobSelect($event);
          })("onDeSelect", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_8_listener($event) {
            return ctx.OnJobDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_12_listener($event) {
            return ctx.SelectedFuelTypes = $event;
          })("onSelect", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onSelect_12_listener($event) {
            return ctx.onFuelSelect($event);
          })("onDeSelect", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_12_listener($event) {
            return ctx.onFuelDeSelect($event);
          })("onSelectAll", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onSelectAll_12_listener($event) {
            return ctx.onFuelSelect($event);
          })("onDeSelectAll", function CreateSameDestGroupComponent_Template_ng_multiselect_dropdown_onDeSelectAll_12_listener($event) {
            return ctx.onAllFuelDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateSameDestGroupComponent_Template_input_click_26_listener() {
            return ctx.clearDestGroupForm();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CreateSameDestGroupComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  "./src/app/order/filter-group/filter-group.component.ts": function srcAppOrderFilterGroupFilterGroupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FilterGroupComponent", function () {
    ...
    var _models_ViewOrderGroupDdlModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../models/ViewOrderGroupDdlModel */
    ...
    var _services_viewordergroup_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../services/viewordergroup.service */
    ...
    function FilterGroupComponent_option_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilterGroupComponent_label_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilterGroupComponent_label_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "label");
    ...
    function FilterGroupComponent_div_15_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function FilterGroupComponent_div_15_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);

          var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r8.SelectedJob = $event;
        })("onSelect", function FilterGroupComponent_div_15_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.OnJobSelect($event);
        })("onDeSelect", function FilterGroupComponent_div_15_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.OnJobDeSelect($event);
        });
    ...
    function FilterGroupComponent_div_16_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function FilterGroupComponent_div_16_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r12.SelectedFuelGroup = $event;
        })("onSelect", function FilterGroupComponent_div_16_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r14.OnFuelGroupSelect($event);
        })("onDeSelect", function FilterGroupComponent_div_16_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r15.OnFuelGroupDeSelect($event);
        });
    ...
    function FilterGroupComponent_div_17_Template(rf, ctx) {
      if (rf & 1) {
        var _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function FilterGroupComponent_div_17_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);

          var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r16.SelectedState = $event;
        })("onSelect", function FilterGroupComponent_div_17_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);

          var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r18.OnStateSelect($event);
        })("onDeSelect", function FilterGroupComponent_div_17_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);

          var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r19.OnStateDeSelect($event);
        });
    ...
    function FilterGroupComponent_div_26_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var FilterGroupComponent = /*#__PURE__*/function () {
      function FilterGroupComponent(fb, viewOrderGroupService, orderService) {
        _classCallCheck(this, FilterGroupComponent);
      ...
      _createClass(FilterGroupComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this13 = this;
          ...
          this.viewOrderGroupService.fillDDLByGroup(this.model.GroupTypeId).subscribe(function (data) {
            _this13.GroupTypeList = data.GroupTypes;
            _this13.CompanyList = data.Companies;
            _this13.FuelGroupList = data.ProductCategories;
            _this13.StateList = data.States;
            _this13.IsSupplierCompany = data.IsSupplierCompany;
          });
          this.showHideControlsByGroupType(this.model.GroupTypeId);
          this.onOrderGroupFilterSubmit();
        }
      }, {
        key: "showHideControlsByGroupType",
        value: function showHideControlsByGroupType(groupTypeId) {
          if (groupTypeId == 2) {
            this.IsTier = true;
        ...
        key: "OnGroupTypeSelect",
        value: function OnGroupTypeSelect(groupType) {
          var _this14 = this;
          ...
          this.showHideControlsByGroupType(this.model.GroupTypeId);
          this.viewOrderGroupService.fillDDLByGroup(this.model.GroupTypeId).subscribe(function (data) {
            _this14.CompanyList = data.Companies;
            _this14.FuelGroupList = data.ProductCategories;
            _this14.StateList = data.States;
            _this14.IsLoading = false;
          });
          this.onOrderGroupFilterSubmit();
        }
      }, {
        key: "onOrderGroupFilterSubmit",
        value: function onOrderGroupFilterSubmit() {
          var _this15 = this;

          this.IsLoading = true;
          this.model.SearchText = this.filterGroupForm.get('SearchText').value;
          this.viewOrderGroupService.getOrderGroupDetails(this.model).subscribe(function (data) {
            _this15.IsLoading = false;

            _this15.onViewOrderGroupResponse.emit(data);
          });
        }
      }, {
        key: "resetForm",
        ...
        value: function onSearch(searchText) {
          ...
          if (text != null && text != '' && text.length >= 3) {
            ...
            this.viewOrderGroupService.getOrderGroupDetails(this.model).subscribe(function (data) {
              ...
              _this16.onViewOrderGroupResponse.emit(data);
            });
        ...
        value: function OnCompanySelect(company) {
          ...
          this.JobList = [];
          this.orderService.getCommonJobList(company.Id).subscribe(function (data) {
            return _this17.JobList = data;
          });
        }
      }, {
        key: "OnCompanyDeSelect",
        value: function OnCompanyDeSelect(groupType) {
          this.JobList = [];
        ...
        key: "OnJobDeSelect",
        value: function OnJobDeSelect(groupType) {
          this.model.JobId = null;
        }
      }, {
        key: "OnFuelGroupSelect",
        value: function OnFuelGroupSelect(fuelGroup) {
          this.model.ProductCategoryId = fuelGroup.Id;
        }
      }, {
        key: "OnFuelGroupDeSelect",
        value: function OnFuelGroupDeSelect(fuelGroup) {
    ...
    FilterGroupComponent.ɵfac = function FilterGroupComponent_Factory(t) {
      return new (t || FilterGroupComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_viewordergroup_service__WEBPACK_IMPORTED_MODULE_3__["ViewOrderGroupService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_order_service__WEBPACK_IMPORTED_MODULE_4__["OrderService"]));
    };

    FilterGroupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: FilterGroupComponent,
      selectors: [["app-filter-group"]],
      outputs: {
        onViewOrderGroupResponse: "onViewOrderGroupResponse"
      },
      decls: 27,
      vars: 12,
      consts: [[1, "row"], [1, "col-sm-2"], [1, "form-group"], [1, "form-control", 3, "change"], ["value", "0"], [3, "ngValue", "value", 4, "ngFor", "ngForOf"], [4, "ngIf"], [3, "ngModel", "settings", "data", "ngModelChange", "onSelect", "onDeSelect"], ["class", "col-sm-2", 4, "ngIf"], [3, "formGroup"], ["type", "submit", "value", "Apply", 1, "btn", "btn-primary", "btn-submit", "btn-lg", "no-disable", 3, "click"], ["type", "text", "formControlName", "SearchText", 1, "form-control", 3, "keypress"], ["class", "loader", 4, "ngIf"], [3, "ngValue", "value"], [1, "loader"], [1, "loading-content", "text-center"], [1, "spinner"], [1, "font-bold"]],
      template: function FilterGroupComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function FilterGroupComponent_Template_select_change_6_listener($event) {
            return ctx.OnGroupTypeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function FilterGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_14_listener($event) {
            return ctx.SelectedCompany = $event;
          })("onSelect", function FilterGroupComponent_Template_ng_multiselect_dropdown_onSelect_14_listener($event) {
            return ctx.OnCompanySelect($event);
          })("onDeSelect", function FilterGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_14_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FilterGroupComponent_Template_input_click_20_listener() {
            return ctx.onOrderGroupFilterSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keypress", function FilterGroupComponent_Template_input_keypress_25_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FilterGroupComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: _services_viewordergroup_service__WEBPACK_IMPORTED_MODULE_3__["ViewOrderGroupService"]
        }, {
          type: _services_order_service__WEBPACK_IMPORTED_MODULE_4__["OrderService"]
        }];
      }, {
        onViewOrderGroupResponse: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"]
        }]
      });
    })();
  ...
  /***/
  "./src/app/order/lazy-loading/order-routing.module.ts": function srcAppOrderLazyLoadingOrderRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _view_order_group_view_order_group_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../view-order-group/view-order-group.component */
    ...
    OrderRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routeOrder)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OrderRoutingModule, [{
        ...
        args: [{
          imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routeOrder)],
          exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
        }]
      }], null, null);
    })();
  ...
  /***/
  "./src/app/order/lazy-loading/order.module.ts": function srcAppOrderLazyLoadingOrderModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _view_order_group_view_order_group_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../view-order-group/view-order-group.component */
    "./src/app/order/view-order-group/view-order-group.component.ts");
    /* harmony import */
    ...
    var _create_blend_group_create_blend_group_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../create-blend-group/create-blend-group.component */
    "./src/app/order/create-blend-group/create-blend-group.component.ts");
    /* harmony import */


    var _create_same_dest_group_create_same_dest_group_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../create-same-dest-group/create-same-dest-group.component */
    "./src/app/order/create-same-dest-group/create-same-dest-group.component.ts");
    /* harmony import */


    var _filter_group_filter_group_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../filter-group/filter-group.component */
    "./src/app/order/filter-group/filter-group.component.ts");
    /* harmony import */


    var _term_pricing_contract_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../term-pricing-contract.component */
    "./src/app/order/term-pricing-contract.component.ts");
    /* harmony import */


    var src_app_modules_shared_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/modules/shared.module */
    "./src/app/modules/shared.module.ts");
    /* harmony import */


    var src_app_modules_directive_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    OrderModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_order_routing_module__WEBPACK_IMPORTED_MODULE_2__["OrderRoutingModule"], src_app_modules_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], src_app_modules_directive_module__WEBPACK_IMPORTED_MODULE_8__["DirectiveModule"], ng_drag_drop__WEBPACK_IMPORTED_MODULE_9__["NgDragDropModule"].forRoot()]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](OrderModule, {
        declarations: [_view_order_group_view_order_group_component__WEBPACK_IMPORTED_MODULE_1__["ViewOrderGroupComponent"], _create_blend_group_create_blend_group_component__WEBPACK_IMPORTED_MODULE_3__["CreateBlendGroupComponent"], _create_same_dest_group_create_same_dest_group_component__WEBPACK_IMPORTED_MODULE_4__["CreateSameDestGroupComponent"], _filter_group_filter_group_component__WEBPACK_IMPORTED_MODULE_5__["FilterGroupComponent"], _term_pricing_contract_component__WEBPACK_IMPORTED_MODULE_6__["TermPricingContractComponent"]],
        imports: [_order_routing_module__WEBPACK_IMPORTED_MODULE_2__["OrderRoutingModule"], src_app_modules_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], src_app_modules_directive_module__WEBPACK_IMPORTED_MODULE_8__["DirectiveModule"], ng_drag_drop__WEBPACK_IMPORTED_MODULE_9__["NgDragDropModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  "./src/app/order/models/OrderDetail.ts": function srcAppOrderModelsOrderDetailTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OrderGroupViewModel", function () {
      return OrderGroupViewModel;
    });
    ...
    var OrderGroupViewModel = function OrderGroupViewModel() {
      _classCallCheck(this, OrderGroupViewModel);
    };
    /***/
  ...
  /***/
  "./src/app/order/models/ViewOrderGroupDdlModel.ts": function srcAppOrderModelsViewOrderGroupDdlModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewOrderGroupDdlModel", function () {
      return ViewOrderGroupDdlModel;
    });

    var ViewOrderGroupDdlModel = function ViewOrderGroupDdlModel() {
      _classCallCheck(this, ViewOrderGroupDdlModel);
    };
    /***/
  ...
  /***/
  "./src/app/order/services/order.service.ts": function srcAppOrderServicesOrderServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var OrderService = /*#__PURE__*/function (_src_app_errors_Handl) {
      _inherits(OrderService, _src_app_errors_Handl);
      ...
      function OrderService(httpClient) {
        ...
        _this18.getCustomerListUrl = '/Supplier/OrderGroup/GetCustomersForSupplier';
        _this18.getJobListUrl = '/Supplier/OrderGroup/GetJobsForCustomer?buyerCompanyId=';
        _this18.getCommonJobListUrl = '/OrderBase/GetJobsForCustomers?companyId=';
        _this18.postCreateGroupUrl = '/OrderBase/CreateOrderGroup';
        _this18.postEditGroupUrl = '/OrderBase/EditOrderGroup';
        _this18.getFilteredOrders = '/OrderBase/GetFilteredOrders';
        _this18.getFuelTypes = '/OrderBase/GetFuelTypes?';
        _this18.getCurrentUserUrl = '/OrderBase/GetUserContext';
        _this18.getSupplierListUrl = '/Buyer/OrderGroup/GetSuppliersForCustomer';
        _this18.getGroupDetailsUrl = '/OrderBase/GetOrderGroupDetails?groupId=';
        _this18.getBlendedGroupDetailstUrl = '/OrderBase/GetBlendedGroupDetails?groupId=';
        return _this18;
      }
      ...
      _createClass(OrderService, [{
        ...
        key: "getBlendGroupDetails",
        value: function getBlendGroupDetails(groupId) {
        ...
        key: "getJobList",
        value: function getJobList(customerId) {
        ...
        key: "getCommonJobList",
        value: function getCommonJobList(customerId) {
        ...
        key: "getFilteredOrdersList",
        value: function getFilteredOrdersList(customerId, jobId, tfxFuelTypeIds, groupId) {
          return this.httpClient.post(this.getFilteredOrders, {
            customerId: customerId,
            jobId: jobId,
            tfxFuelTypeIds: tfxFuelTypeIds,
            groupId: groupId
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('getFilteredOrdersList', null)));
        }
      }, {
        key: "getJobListByFuelGroupType",
        value: function getJobListByFuelGroupType(customerId, supplierId, fuelGroupType) {
        ...
        key: "getOrderList",
        value: function getOrderList(buyerCompanyId, supplierCompanyId, fuelGroupType, jobId) {
        ...
        key: "getGroupDetails",
        value: function getGroupDetails(groupId) {
        ...
        key: "getOrderListUrl",
        value: function getOrderListUrl(a, b, c, d) {
          return "/OrderBase/GetOrdersForTierGroup?buyerCompanyId=".concat(a, "&supplierCompanyId=").concat(b, "&fuelGroupType=").concat(c, "&jobId=").concat(d);
        }
      }, {
        key: "getFuelTypesList",
        value: function getFuelTypesList(customerId, jobId) {
        ...
        key: "getJobListByFuelGroupUrl",
        value: function getJobListByFuelGroupUrl(a, b, c) {
          return "/OrderBase/GetJobsByFuelGroup?buyerCompanyId=".concat(a, "&supplierCompanyId=").concat(b, "&fuelGroupType=").concat(c);
        }
      }, {
        key: "postCreateGroup",
        value: function postCreateGroup(groupModel) {
          return this.httpClient.post(this.postCreateGroupUrl, groupModel).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('postCreateGroup', null)));
        }
      }, {
        key: "postEditGroup",
        value: function postEditGroup(groupModel) {
          return this.httpClient.post(this.postEditGroupUrl, groupModel).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('postEditGroup', null)));
        }
      }]);
  ...
  /***/
  "./src/app/order/services/shared.service.ts": function srcAppOrderServicesSharedServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/order/services/viewordergroup.service.ts": function srcAppOrderServicesViewordergroupServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewOrderGroupService", function () {
      return ViewOrderGroupService;
    });
    /* harmony import */
    ...
    var ViewOrderGroupService = /*#__PURE__*/function (_errors_HandleError__) {
      _inherits(ViewOrderGroupService, _errors_HandleError__);

      var _super2 = _createSuper(ViewOrderGroupService);

      function ViewOrderGroupService(httpClient) {
        var _this19;

        _classCallCheck(this, ViewOrderGroupService);

        _this19 = _super2.call(this);
        _this19.httpClient = httpClient;
        _this19.getOrderGroupAllDdlUrl = '/OrderBase/FillOrderGroupDdl?groupTypeId=';
        _this19.viewOrderGroupDetailsUrl = '/OrderBase/ViewOrderGroupDetails';
        _this19.getCommonJobListUrl = '/OrderBase/GetJobsForCustomers?companyId=';
        _this19.getDeleteOrderGroupUrl = '/OrderBase/DeleteOrderGroup?groupId=';
        return _this19;
      }

      _createClass(ViewOrderGroupService, [{
        key: "fillDDLByGroup",
        value: function fillDDLByGroup(groupTypeId) {
          return this.httpClient.get(this.getOrderGroupAllDdlUrl + groupTypeId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('fillViewOrderGroupAllDDL', null)));
        }
      }, {
        key: "getOrderGroupDetails",
        value: function getOrderGroupDetails(viewOrderGroupFilterModel) {
          return this.httpClient.post(this.viewOrderGroupDetailsUrl, viewOrderGroupFilterModel).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('getOrderGroupDetails', null)));
        }
      }, {
        key: "getCommonJobList",
        value: function getCommonJobList(customerId) {
        ...
        key: "deleteOrderGroup",
        value: function deleteOrderGroup(groupId) {
    ...
    ViewOrderGroupService.ɵfac = function ViewOrderGroupService_Factory(t) {
      return new (t || ViewOrderGroupService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]));
    };

    ViewOrderGroupService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ViewOrderGroupService,
      factory: ViewOrderGroupService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ViewOrderGroupService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  /***/
  "./src/app/order/term-pricing-contract.component.ts": function srcAppOrderTermPricingContractComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TermPricingContractComponent", function () {
      return TermPricingContractComponent;
    });
    /* harmony import */
    ...
    var _order_models_OrderDetail__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var ng_drag_drop__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ng-drag-drop */
    "./node_modules/ng-drag-drop/__ivy_ngcc__/index.js");
    /* harmony import */


    var ng_drag_drop__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop__WEBPACK_IMPORTED_MODULE_10__);
    /* harmony import */
    ...
    function TermPricingContractComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TermPricingContractComponent_div_1_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.SelectedCustomer = $event;
        })("onSelect", function TermPricingContractComponent_div_1_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r9.OnCustomerSelect($event);
        })("onDeSelect", function TermPricingContractComponent_div_1_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.OnCustomerDeSelect($event);
        });
    ...
    function TermPricingContractComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TermPricingContractComponent_div_2_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.SelectedSupplier = $event;
        })("onSelect", function TermPricingContractComponent_div_2_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r13.OnSupplierSelect($event);
        })("onDeSelect", function TermPricingContractComponent_div_2_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r14.OnSupplierDeSelect($event);
        });
    ...
    function TermPricingContractComponent_div_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TermPricingContractComponent_ng_container_20_span_12_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_ng_container_20_span_12_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_ng_container_20_span_12_span_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_ng_container_20_span_12_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var tier_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function TermPricingContractComponent_ng_container_20_span_16_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_ng_container_20_span_16_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_ng_container_20_span_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 43);
    ...
    function TermPricingContractComponent_ng_container_20_div_20_h3_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TermPricingContractComponent_ng_container_20_div_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 44);
    ...
    function TermPricingContractComponent_ng_container_20_div_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function TermPricingContractComponent_ng_container_20_span_22_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_ng_container_20_span_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 43);
    ...
    function TermPricingContractComponent_ng_container_20_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TermPricingContractComponent_ng_container_20_Template_a_click_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r35);

          var tier_r15 = ctx.$implicit;
          var i_r16 = ctx.index;

          var ctx_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r34.removeTier(tier_r15, i_r16);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TermPricingContractComponent_ng_container_20_Template_input_change_11_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r35);
          ...
          return ctx_r36.comparisonValidator(tier_r15, i_r16, "MinVolume");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TermPricingContractComponent_ng_container_20_Template_input_change_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r35);
          ...
          return ctx_r37.comparisonValidator(tier_r15, i_r16, "MaxVolume");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onDrop", function TermPricingContractComponent_ng_container_20_Template_div_onDrop_19_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r35);
          ...
          return ctx_r38.onItemDropTier(i_r16, $event);
        });
    ...
    function TermPricingContractComponent_div_29_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TermPricingContractComponent_span_42_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_span_42_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_span_42_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TermPricingContractComponent_span_50_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TermPricingContractComponent_span_50_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 50);
    ...
    var TermPricingContractComponent = /*#__PURE__*/function () {
      function TermPricingContractComponent(fb, orderService, viewGroupService) {
        _classCallCheck(this, TermPricingContractComponent);
        ...
        this.OrderList = [];
        this.DefaultTier = {
          Order: new _order_models_OrderDetail__WEBPACK_IMPORTED_MODULE_2__["OrderDetailModel"](),
          OrderId: null,
          MinVolume: null,
          MaxVolume: null
        };
        this.CurrentUser = {
          IsBuyerCompany: !IsSupplierCompany,
      ...
      _createClass(TermPricingContractComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this20 = this;
        ...
        key: "getDefaultGroupDetail",
        value: function getDefaultGroupDetail(_groupId) {
          var _this21 = this;

          this.orderService.getGroupDetails(_groupId).subscribe(function (response) {
            _this21.OrderGroupModel = response;

            _this21.initFormData(response);
          });
        }
      }, {
        key: "initFormData",
        value: function initFormData(model) {
          if (model != null && model != undefined && model.Id > 0) {
            ...
            this.SelectedCustomer = this.CustomerList.filter(function (item) {
              return item.Id == model.BuyerCompanyId;
            });
            this.SelectedSupplier = this.SupplierList.filter(function (item) {
              return item.Id == model.SupplierCompanyId;
            });
            this.SelectedJob = this.JobList.filter(function (item) {
              return item.Id == model.JobId;
            });
            this.SelectedFuelGroup = this.FuelGroupList.filter(function (item) {
              return item.Id == model.ProductType;
            }); //this.Tiers = model.OrderList;

            this.Orders = this.Orders.filter(function (item) {
              return model.OrderList.filter(function (t) {
        ...
        value: function GetCustomerList() {
          ...
          this.orderService.getCustomerList().subscribe(function (data) {
            ...
            if (data.length > 0) {
              _this22.SelectedCustomer = [data[0]];

              _this22.TermPricingForm.get('BuyerCompanyId').patchValue(data[0].Id);

              _this22.OnCustomerSelect(data[0]);
            }
          });
        }
      }, {
        ...
        value: function GetSupplierList() {
          ...
          this.orderService.getSupplierList().subscribe(function (data) {
            _this23.SupplierList = data;

            if (data.length > 0) {
              _this23.SelectedSupplier = [data[0]];

              _this23.TermPricingForm.get('SupplierCompanyId').patchValue(data[0].Id);

              _this23.OnSupplierSelect(data[0]);
            }
          });
        }
      }, {
        ...
        value: function OnCustomerSelect(customer) {
          ...
          if (customer != null && customer != undefined && customer.Id > 0 && productType > 0 && selectedsupplier > 0) {
            this.orderService.getJobListByFuelGroupType(customer.Id, selectedsupplier, productType).subscribe(function (data) {
              _this24.JobList = data;

              if (data.length > 0) {
                _this24.SelectedJob = [data[0]];

                _this24.TermPricingForm.get('JobId').patchValue(data[0].Id);

                _this24.OnJobSelect(data[0]);
              } else {
                _this24.SelectedJob = [];
                formOrderList.clear();
                _this24.OrderList = [];

                _this24.addNewTier(_this24.DefaultTier);

                _this24.TermPricingForm.get('JobId').patchValue(null);
        ...
        value: function OnSupplierSelect(supplier) {
          var _this25 = this;
          ...
          if (supplier != null && supplier != undefined && supplier.Id > 0 && productType > 0 && customer > 0) {
            this.orderService.getJobListByFuelGroupType(customer, supplier.Id, productType).subscribe(function (data) {
              _this25.JobList = data;

              if (data.length > 0) {
                _this25.SelectedJob = [data[0]];

                _this25.TermPricingForm.get('JobId').patchValue(data[0].Id);

                _this25.OnJobSelect(data[0]);
              } else {
                _this25.SelectedJob = [];
                _this25.Orders = [];
                formOrderList.clear();
                ...
                _this25.addNewTier(_this25.DefaultTier);

                _this25.TermPricingForm.get('JobId').patchValue(null);
              }
            });
          } else {
            this.JobList = [];
        ...
        key: "OnSupplierDeSelect",
        value: function OnSupplierDeSelect(supplier) {
        ...
        value: function OnFuelGroupSelect(fuelGroup) {
          ...
          if (customer != null && customer != undefined && customer > 0 && fuelGroup.Id > 0 && selectedsupplier > 0) {
            this.orderService.getJobListByFuelGroupType(customer, selectedsupplier, fuelGroup.Id).subscribe(function (data) {
              _this26.JobList = data;

              if (data.length > 0) {
                _this26.SelectedJob = [data[0]];

                _this26.TermPricingForm.get('JobId').patchValue(data[0].Id);

                _this26.OnJobSelect(data[0]);
              } else {
                _this26.SelectedJob = [];
                _this26.Orders = [];
                formOrderList.clear();
                ...
                _this26.addNewTier(_this26.DefaultTier);

                _this26.TermPricingForm.get('JobId').patchValue(null);
              }
            });
          } else {
            this.JobList = [];
        ...
        value: function OnJobSelect(job) {
          ...
          this.OrderList = [];
          this.addNewTier(this.DefaultTier);
          this.orderService.getOrderList(selectedcustomer, selectedsupplier, productType, job.Id).subscribe(function (data) {
            _this27.Orders = data;
          });
        }
      }, {
        ...
        value: function onSubmit() {
          ...
          if (this.TermPricingForm.valid && this.validateTierControls()) {
            this.orderService.postCreateGroup(this.TermPricingForm.value).subscribe(function (data) {
              if (data != null && data.StatusCode == 0) {
                ...
                window.location.href = _this28.CurrentUser.IsBuyerCompany ? "/Buyer/OrderGroup/View" : "/Supplier/OrderGroup/View"; //this.TermPricingForm.reset();
              } else {
                _this28.IsLoading = false;
            ...
            var invalidControls = this.findInvalidControlsRecursive(this.TermPricingForm);
          }
        }
      }, {
        ...
        key: "addNewTier",
        value: function addNewTier(model) {
        ...
        key: "buildTier",
        value: function buildTier(model) {
          return this.fb.group({
            Order: this.fb.group({
        ...
        key: "removeTier",
        value: function removeTier(tier, index) {
        ...
        key: "onItemDropTier",
        value: function onItemDropTier(index, event) {
          var tierList = this.TermPricingForm.get('OrderList');
          var existingOrderinTier = this.OrderList[index].Order;
          var indexOfSameOrderinAnotherTier = this.OrderList.findIndex(function (t) {
            return t.OrderId == event.dragData.OrderId;
          });
          ...
          this.Orders = this.Orders.filter(function (element) {
            return element.OrderId != event.dragData.OrderId;
          });
        ...
        key: "onItemDropOrder",
        value: function onItemDropOrder(event) {
          if (this.Orders.findIndex(function (t) {
            return t.OrderId == event.dragData.OrderId;
          }) < 0) {
            this.Orders.push(event.dragData);
          }

          var index = this.OrderList.findIndex(function (t) {
            return t.OrderId == event.dragData.OrderId;
          });
        ...
        value: function isRequired(drop, name) {
          return drop.get(name).errors.required && (drop.get(name).dirty || drop.get(name).touched);
        }
      }, {
        key: "isMin",
        ...
        key: "getNextRenewalDate",
        value: function getNextRenewalDate(date) {
        ...
        value: function comparisonValidator(group, index, controlName) {
          var minVolume = group.get('MinVolume');
          var maxVolume = group.get('MaxVolume');

          if (minVolume.value !== null && maxVolume.value !== null && parseInt(minVolume.value) >= parseInt(maxVolume.value)) {
            group.get(controlName).setErrors({
              notEquivalent: true
            });
          }
        }
      }, {
        key: "validateTierControls",
        value: function validateTierControls() {
          var tierList = this.TermPricingForm.get('OrderList');
    ...
    TermPricingContractComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function TermPricingContractComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TermPricingContractComponent_Template_ng_multiselect_dropdown_ngModelChange_7_listener($event) {
            return ctx.SelectedFuelGroup = $event;
          })("onSelect", function TermPricingContractComponent_Template_ng_multiselect_dropdown_onSelect_7_listener($event) {
            return ctx.OnFuelGroupSelect($event);
          })("onDeSelect", function TermPricingContractComponent_Template_ng_multiselect_dropdown_onDeSelect_7_listener($event) {
            return ctx.OnFuelGroupDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TermPricingContractComponent_Template_ng_multiselect_dropdown_ngModelChange_12_listener($event) {
            return ctx.SelectedJob = $event;
          })("onSelect", function TermPricingContractComponent_Template_ng_multiselect_dropdown_onSelect_12_listener($event) {
            return ctx.OnJobSelect($event);
          })("onDeSelect", function TermPricingContractComponent_Template_ng_multiselect_dropdown_onDeSelect_12_listener($event) {
            return ctx.OnJobDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function TermPricingContractComponent_Template_form_ngSubmit_13_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TermPricingContractComponent_Template_a_click_23_listener() {
            return ctx.addNewTier(null);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onDrop", function TermPricingContractComponent_Template_div_onDrop_27_listener($event) {
            return ctx.onItemDropOrder($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onDateChange", function TermPricingContractComponent_Template_input_onDateChange_47_listener($event) {
            ctx.TermPricingForm.get("StartDate").setValue($event);
            return ctx.getNextRenewalDate($event);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TermPricingContractComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  "./src/app/order/view-order-group/view-order-group.component.ts": function srcAppOrderViewOrderGroupViewOrderGroupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewOrderGroupComponent", function () {
      return ViewOrderGroupComponent;
    });
    /* harmony import */
    ...
    var _create_blend_group_create_blend_group_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../create-blend-group/create-blend-group.component */
    "./src/app/order/create-blend-group/create-blend-group.component.ts");
    /* harmony import */
    ...
    var _models_ViewOrderGroupDdlModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../models/ViewOrderGroupDdlModel */
    "./src/app/order/models/ViewOrderGroupDdlModel.ts");
    /* harmony import */
    ...
    var _services_viewordergroup_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../services/viewordergroup.service */
    "./src/app/order/services/viewordergroup.service.ts");
    /* harmony import */
    ...
    var _term_pricing_contract_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../term-pricing-contract.component */
    "./src/app/order/term-pricing-contract.component.ts");

    function ViewOrderGroupComponent_div_18_Template(rf, ctx) {
      if (rf & 1) {
        var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSubmitGroupData", function ViewOrderGroupComponent_div_18_Template_app_create_blend_group_onSubmitGroupData_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r13.onOrderGroupFilterSubmit();
        });
    ...
    function ViewOrderGroupComponent_div_19_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSubmitGroupData", function ViewOrderGroupComponent_div_19_Template_app_create_same_dest_group_onSubmitGroupData_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r15.onOrderGroupFilterSubmit();
        });
    ...
    function ViewOrderGroupComponent_div_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_option_35_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewOrderGroupComponent_label_38_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "label");
    ...
    function ViewOrderGroupComponent_label_39_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "label");
    ...
    function ViewOrderGroupComponent_div_41_Template(rf, ctx) {
      if (rf & 1) {
        var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ViewOrderGroupComponent_div_41_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);

          var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r18.SelectedJob = $event;
        })("onSelect", function ViewOrderGroupComponent_div_41_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);

          var ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r20.OnJobSelect($event);
        })("onDeSelect", function ViewOrderGroupComponent_div_41_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);

          var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r21.OnJobDeSelect($event);
        });
    ...
    function ViewOrderGroupComponent_div_42_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ViewOrderGroupComponent_div_42_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23);

          var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r22.SelectedFuelGroup = $event;
        })("onSelect", function ViewOrderGroupComponent_div_42_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23);

          var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r24.OnFuelGroupSelect($event);
        })("onDeSelect", function ViewOrderGroupComponent_div_42_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23);

          var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r25.OnFuelGroupDeSelect($event);
        });
    ...
    function ViewOrderGroupComponent_div_43_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ViewOrderGroupComponent_div_43_Template_ng_multiselect_dropdown_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r27);

          var ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r26.SelectedState = $event;
        })("onSelect", function ViewOrderGroupComponent_div_43_Template_ng_multiselect_dropdown_onSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r27);

          var ctx_r28 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r28.OnStateSelect($event);
        })("onDeSelect", function ViewOrderGroupComponent_div_43_Template_ng_multiselect_dropdown_onDeSelect_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r27);

          var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r29.OnStateDeSelect($event);
        });
    ...
    function ViewOrderGroupComponent_div_57_a_12_Template(rf, ctx) {
      if (rf & 1) {
        var _r40 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 59);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_div_57_a_12_Template_a_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r40);

          var grp_r30 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r38 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r38.OpenEditSlider(grp_r30.OrderGroupId, grp_r30.GroupType);
        });
    ...
    function ViewOrderGroupComponent_div_57_a_13_Template(rf, ctx) {
      if (rf & 1) {
        var _r43 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 61);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_div_57_a_13_Template_a_click_0_listener() {
          ...
          return ctx_r41.SetOrderGroupIdToDelete(grp_r30.OrderGroupId);
        });
    ...
    function ViewOrderGroupComponent_div_57_div_14_div_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var grp_r30 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    ...
    function ViewOrderGroupComponent_div_57_div_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewOrderGroupComponent_div_57_div_15_span_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewOrderGroupComponent_div_57_div_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_2_div_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      if (rf & 2) {
        var drop_r51 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_2_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      if (rf & 2) {
        ...
        var j_r52 = ctx_r61.index;
        var drop_r51 = ctx_r61.$implicit;
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_2_div_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_2_span_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_2_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var drop_r51 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_3_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_3_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_3_span_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 76);
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 71);
      ...
      if (rf & 2) {
        ...
        var drop_r51 = ctx_r70.$implicit;
        var j_r52 = ctx_r70.index;
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_4_div_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_4_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_4_span_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 76);
    ...
    function ViewOrderGroupComponent_div_57_div_18_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 71);
    ...
    function ViewOrderGroupComponent_div_57_div_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function ViewOrderGroupComponent_div_57_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 21);
    ...
    function ViewOrderGroupComponent_div_58_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ViewOrderGroupComponent = /*#__PURE__*/function () {
      function ViewOrderGroupComponent(fb, viewOrderGroupService, sharedService, orderService) {
        _classCallCheck(this, ViewOrderGroupComponent);
        ...
        this.IsMultiProduct = true;
        this.IsTier = false;
        this.IsBlend = false; // public SearchText: string;
      ...
      _createClass(ViewOrderGroupComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.model.GroupTypeId = 0;
        ...
        key: "fillDDLByGroup",
        value: function fillDDLByGroup() {
          var _this29 = this;

          this.IsLoading = true;
          this.viewOrderGroupService.fillDDLByGroup(this.model.GroupTypeId).subscribe(function (data) {
            _this29.GroupTypeList = data.GroupTypes;
            _this29.CompanyList = data.Companies;
            _this29.FuelGroupList = data.ProductCategories;
            _this29.StateList = data.States;
            _this29.IsSupplierCompany = data.IsSupplierCompany;

            _this29.onOrderGroupFilterSubmit();
          });
        ...
        key: "ButtonPressed",
        value: function ButtonPressed(_SelectedButton) {
        ...
        value: function OnGroupTypeSelect(groupType) {
          ...
          this.showHideControlsByGroupType(this.model.GroupTypeId);
          this.viewOrderGroupService.fillDDLByGroup(this.model.GroupTypeId).subscribe(function (data) {
            _this30.CompanyList = data.Companies;
            _this30.FuelGroupList = data.ProductCategories;
            _this30.StateList = data.States;

            _this30.onOrderGroupFilterSubmit();
          });
        }
      }, {
        key: "onOrderGroupFilterSubmit",
        value: function onOrderGroupFilterSubmit() {
          ...
          this.IsLoading = true;
          this.viewOrderGroupService.getOrderGroupDetails(this.model).subscribe(function (data) {
            _this31.groups = data.OrderGroupDetails;
            _this31.TotalGroupCount = data.TotalGroupCount;
            _this31.ShowCount = data.ShowCount;
        ...
        value: function resetForm() {
          ...
          this.SelectedJob = [];
          this.SelectedFuelGroup = [];
          this.SelectedState = []; //this.onViewOrderGroupResponse.emit([]);
        ...
        value: function onSearch(text) {
          ...
          if (text != null && text != '' && text.length >= 3) {
            ...
            this.viewOrderGroupService.getOrderGroupDetails(this.model).subscribe(function (data) {
              ...
              _this32.groups = data.OrderGroupDetails;
              _this32.TotalGroupCount = data.TotalGroupCount;
              _this32.ShowCount = data.ShowCount; //this.onViewOrderGroupResponse.emit(data);
            });
          } else if (text.length == 0) {
            this.IsLoading = true;
            this.model.SearchText = null;
        ...
        value: function OnCompanySelect(company) {
          ...
          this.JobList = [];
          this.orderService.getCommonJobList(company.Id).subscribe(function (data) {
            return _this33.JobList = data;
          });
        }
      }, {
        key: "OnCompanyDeSelect",
        value: function OnCompanyDeSelect(company) {
          this.JobList = [];
          this.model.CompanyId = null;
        }
      }, {
        ...
        key: "SetOrderGroupIdToDelete",
        value: function SetOrderGroupIdToDelete(orderGroupId) {
          this.SelectedOrderGroupIdToDelete = orderGroupId;
        }
      }, {
        key: "deleteOrderGroup",
        value: function deleteOrderGroup() {
          var _this34 = this;
          ...
          this.IsLoading = true;
          this.viewOrderGroupService.deleteOrderGroup(this.SelectedOrderGroupIdToDelete).subscribe(function (data) {
            if (data != null && data.StatusCode == 0) {
              src_app_declarations_module__WEBPACK_IMPORTED_MODULE_2__["Declarations"].msgsuccess(data.StatusMessage, undefined, undefined);

              _this34.onOrderGroupFilterSubmit();
        ...
        key: "OpenEditSlider",
        value: function OpenEditSlider(OrderGroupId, _SelectedButton) {
          if (this.BlendComponent != undefined) {
    ...
    ViewOrderGroupComponent.ɵfac = function ViewOrderGroupComponent_Factory(t) {
      return new (t || ViewOrderGroupComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_viewordergroup_service__WEBPACK_IMPORTED_MODULE_7__["ViewOrderGroupService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_shared_service__WEBPACK_IMPORTED_MODULE_8__["SharedService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_order_service__WEBPACK_IMPORTED_MODULE_9__["OrderService"]));
    };

    ViewOrderGroupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ViewOrderGroupComponent,
      selectors: [["app-view-order-group"]],
      viewQuery: function ViewOrderGroupComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function ViewOrderGroupComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_button_click_1_listener() {
            return ctx.ButtonPressed("3");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_button_click_4_listener() {
            return ctx.ButtonPressed("1");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_button_click_7_listener() {
            return ctx.ButtonPressed("2");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ViewOrderGroupComponent_Template_select_change_32_listener($event) {
            return ctx.OnGroupTypeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ViewOrderGroupComponent_Template_ng_multiselect_dropdown_ngModelChange_40_listener($event) {
            return ctx.SelectedCompany = $event;
          })("onSelect", function ViewOrderGroupComponent_Template_ng_multiselect_dropdown_onSelect_40_listener($event) {
            return ctx.OnCompanySelect($event);
          })("onDeSelect", function ViewOrderGroupComponent_Template_ng_multiselect_dropdown_onDeSelect_40_listener($event) {
            return ctx.OnCompanyDeSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_input_click_45_listener() {
            return ctx.onOrderGroupFilterSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_button_click_49_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r78);

            var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](53);

            return ctx.onSearch(_r10.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_button_click_65_listener() {
            return ctx.deleteOrderGroup();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ViewOrderGroupComponent_Template_button_click_67_listener() {
            return ctx.SetOrderGroupIdToDelete(0);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ViewOrderGroupComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: _services_viewordergroup_service__WEBPACK_IMPORTED_MODULE_7__["ViewOrderGroupService"]
        }, {
...
//# sourceMappingURL=order-lazy-loading-order-module-es5.js.map