...
namespace SiteFuel.FreightRepository
{
    public interface IScheduleBuilderRepository
    {
        ...
        Task<List<DriverAdditionalDetailsViewModel>> GetAllDriverDetailsAsync(int companyId, List<string> trailerTypeId, string regionId, DateTimeOffset selectedDate);
        ...
        Task<List<SiteFuel.FreightModels.DriverScheduleViewModel>> GetSelectedDateDriverScheduleByDriverId(int driverId, DateTimeOffset selectedDate);
        ...
        Task<List<DriverAdditionalDetailsViewModel>> GetAllDriverDetailsAsync(int companyId, List<string> trailerTypeId, string regionId, string otherRegion, DateTimeOffset selectedDate, string shiftId, bool IsDsbDriverSchedule = false);
